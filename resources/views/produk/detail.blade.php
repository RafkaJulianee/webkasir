...
<div class="mb-4 d-flex align-items-center">
    <a href="{{ route('produk.index') }}" class="btn btn-light shadow-sm bg-white border rounded-3 py-2 px-3 me-3">
    ...
    <div class="row">
        ...
        <div class="col-md-8 ps-md-4">
            <div class="d-flex justify-content-between align-items-center mb-4" style="border-bottom: 2px solid #f1f5f9; padding-bottom: 15px;">
                <h4 class="fw-bold mb-0" style="color: #1e2022;">{{ $produk->nama_produk }}</h4>
                <div>
                    <a href="{{ route('produk.edit', $produk->id) }}" class="btn btn-warning btn-sm fw-medium rounded-3" style="background-color: #fef08a; border-color: #fef08a; color: #854d0e;">
